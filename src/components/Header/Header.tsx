  ...
  return (
    <header>
      <div id="logoWrapper">
        ...
        <a href="#contactFormTitle" id="getInTouch"><img src="./img/icons/form-icon.svg" alt="form icon" /><span>Get In Touch!</span></a>
      </div>

      <h1 id="mainTagline"><span>Upgrade</span> your business!</h1>
      <h3 id="secondTagline">Helping businesses strengthen their online presence with modern technology.</h3>
