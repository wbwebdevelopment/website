  ...
  return (
    <section id="ourProcess">
      ...
      <div id="ourProcessGrid">
        ...
        <div id="gridDesc3" className="grid-desc">Once the site’s development is done and you are happy with your product, we have to get it online! We’ll either use a domain you already own or register a new one, then host it using Cloudflare’s extremely fast CDN network. This is when the site and all it’s assets are handed over to you.</div>
      </div>
      </div>
